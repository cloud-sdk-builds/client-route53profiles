...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1tiEDeI9WvN9CKsjZ1gAAAGySy2P+e+wpxGXnZ3mNhSju0Ti4/om7rVeLMcNOoO6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.677.0/index.min.mjs": "sha384-1tiEDeI9WvN9CKsjZ1gAAAGySy2P+e+wpxGXnZ3mNhSju0Ti4/om7rVeLMcNOoO6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.677.0/LICENSE
```

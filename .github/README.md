...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EM2I4765lUrkQd7jcdB5yQfMceuMp3MOVa2+8EqEHJhcZ2J2GN3e5K3X7lnojqT+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.859.0/index.min.mjs": "sha384-EM2I4765lUrkQd7jcdB5yQfMceuMp3MOVa2+8EqEHJhcZ2J2GN3e5K3X7lnojqT+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.859.0/LICENSE
```

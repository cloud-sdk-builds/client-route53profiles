...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1012.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1012.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X8zlvgTwX7P7+LtKKr+tsvP5NeZlrBIJk4t1vw8cW2YFdGuO1lJoKD4nIG9EqZvQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1012.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1012.0/index.min.mjs": "sha384-X8zlvgTwX7P7+LtKKr+tsvP5NeZlrBIJk4t1vw8cW2YFdGuO1lJoKD4nIG9EqZvQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1012.0/LICENSE
```

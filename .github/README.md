...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-460urFj6Z8ary8QHijf28AQYtEjTmfA3eTKDvdwPKl5AAhKppsz6AQwkH/CH4YhT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.916.0/index.min.mjs": "sha384-460urFj6Z8ary8QHijf28AQYtEjTmfA3eTKDvdwPKl5AAhKppsz6AQwkH/CH4YhT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.916.0/LICENSE
```

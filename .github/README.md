...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JyHJM5reNND5pe8/ijWFljTlSXDjbQqfDASeZNAfzQCRSU+XSEycprmIO2IjBs0z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.954.0/index.min.mjs": "sha384-JyHJM5reNND5pe8/ijWFljTlSXDjbQqfDASeZNAfzQCRSU+XSEycprmIO2IjBs0z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.954.0/LICENSE
```

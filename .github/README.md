...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m49CirX5t1FRamgsSjKocm1D3swe+zn+BaG6nYJsoB8OXVyS07XxeXSj/qU02/tw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.893.0/index.min.mjs": "sha384-m49CirX5t1FRamgsSjKocm1D3swe+zn+BaG6nYJsoB8OXVyS07XxeXSj/qU02/tw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.893.0/LICENSE
```

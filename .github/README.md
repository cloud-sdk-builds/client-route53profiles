...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AzHPMF+A+ixA9Ye+zslrL0rvgFly3h/GSDH2MCFiQBgetvAbhz+AGpg5epfPgSdb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.567.0/index.min.mjs": "sha384-AzHPMF+A+ixA9Ye+zslrL0rvgFly3h/GSDH2MCFiQBgetvAbhz+AGpg5epfPgSdb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.567.0/LICENSE
```

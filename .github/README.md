...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lFopB28Pqz1oCCliHlMPH9Qkh4GmNGZRZ1p9sf35fXSaXzdKWNircZ3m/29Id4uv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.828.0/index.min.mjs": "sha384-lFopB28Pqz1oCCliHlMPH9Qkh4GmNGZRZ1p9sf35fXSaXzdKWNircZ3m/29Id4uv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.828.0/LICENSE
```

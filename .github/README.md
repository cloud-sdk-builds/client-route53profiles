...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-suFdnTb1FnG4peF22ZpmDFXReS/ilQQfMyCyb1qc/5+f+1LHRgE0OravUDAPU6FR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.804.0/index.min.mjs": "sha384-suFdnTb1FnG4peF22ZpmDFXReS/ilQQfMyCyb1qc/5+f+1LHRgE0OravUDAPU6FR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.804.0/LICENSE
```

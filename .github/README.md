...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rXWRB7fP1VBY3WKEshdTeH1pYsUNCyVFjr2JLinTyxW7bMMmGmTWv4nTHin4Vovr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.931.0/index.min.mjs": "sha384-rXWRB7fP1VBY3WKEshdTeH1pYsUNCyVFjr2JLinTyxW7bMMmGmTWv4nTHin4Vovr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.931.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XuTnxGGbFR7ObC7kZnpu+bdzVtTDqu27XCHH3TwDKUtObzV51zvpm0is84Qgcr8l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.858.0/index.min.mjs": "sha384-XuTnxGGbFR7ObC7kZnpu+bdzVtTDqu27XCHH3TwDKUtObzV51zvpm0is84Qgcr8l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.858.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l8kCFnWT76L0NlI4+UZWLXHUkvVnTuEycV6+Hwe4ebm4/FVmEt1UcPJeOI+T5eHM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.935.0/index.min.mjs": "sha384-l8kCFnWT76L0NlI4+UZWLXHUkvVnTuEycV6+Hwe4ebm4/FVmEt1UcPJeOI+T5eHM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.935.0/LICENSE
```

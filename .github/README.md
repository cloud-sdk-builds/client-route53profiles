...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5y30OShOhxuXVM2xWs2qMQlZDji94+m7kdcJ8RVJZ/fawnw0Offw1r85BqoM+lVT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.998.0/index.min.mjs": "sha384-5y30OShOhxuXVM2xWs2qMQlZDji94+m7kdcJ8RVJZ/fawnw0Offw1r85BqoM+lVT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.998.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eq+f2tkvpRcxd8sCz+2RYYuCjghJ8I16KguUcyoww5SVQmGjSkVeNaP49MK4dlWy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.692.0/index.min.mjs": "sha384-eq+f2tkvpRcxd8sCz+2RYYuCjghJ8I16KguUcyoww5SVQmGjSkVeNaP49MK4dlWy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.692.0/LICENSE
```

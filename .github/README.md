...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BIV/j7Nr4Yp0rZDl2q8VXk+2O5JmwROvChmtponVF6NnErF8iqhvHssu3ZhHmTHK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.927.0/index.min.mjs": "sha384-BIV/j7Nr4Yp0rZDl2q8VXk+2O5JmwROvChmtponVF6NnErF8iqhvHssu3ZhHmTHK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.927.0/LICENSE
```

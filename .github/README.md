...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EITNatIhgVNxNDakmHWp/8lka8AKw57TTLDmwLKIntM4mpb99c7G7z/iww8Z1ZOp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.914.0/index.min.mjs": "sha384-EITNatIhgVNxNDakmHWp/8lka8AKw57TTLDmwLKIntM4mpb99c7G7z/iww8Z1ZOp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.914.0/LICENSE
```

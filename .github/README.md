...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qf5WnFAGwi+wofrUdb9HCghd1nVKekeqmUN5pTil4kkloTIXmVqs1jzRO0g7i3yn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.679.0/index.min.mjs": "sha384-qf5WnFAGwi+wofrUdb9HCghd1nVKekeqmUN5pTil4kkloTIXmVqs1jzRO0g7i3yn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.679.0/LICENSE
```

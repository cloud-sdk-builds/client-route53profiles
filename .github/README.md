...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-8pmYYExMP04ets5UegFqOR2vKGig4TqpGs07mqOcJyCluNMOKJoQmiLlD8l+Hw6s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.658.1/index.min.mjs": "sha384-8pmYYExMP04ets5UegFqOR2vKGig4TqpGs07mqOcJyCluNMOKJoQmiLlD8l+Hw6s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.658.1/LICENSE
```

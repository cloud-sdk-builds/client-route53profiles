...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CVsfL+TRtOlCQ9iYB+m/nJYeshTwtgs5r6VI1dN5dMi9ljTajT66CJa22ELOys2h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.983.0/index.min.mjs": "sha384-CVsfL+TRtOlCQ9iYB+m/nJYeshTwtgs5r6VI1dN5dMi9ljTajT66CJa22ELOys2h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.983.0/LICENSE
```

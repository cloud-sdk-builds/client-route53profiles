...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EM/RAWw90RUoi+XCoQZwosD4ZG1CpNcGM4UmJXwDClHCJCuJ71NyTomc6zQG+iLU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.622.0/index.min.mjs": "sha384-EM/RAWw90RUoi+XCoQZwosD4ZG1CpNcGM4UmJXwDClHCJCuJ71NyTomc6zQG+iLU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.622.0/LICENSE
```

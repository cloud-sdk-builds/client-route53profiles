...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-knS/TfS2ZYBD1T1HQMDe0OkCi+wUtwGdcFrXGTw3MG6ZuMqSizrFLsvl8PwK2g8s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.940.0/index.min.mjs": "sha384-knS/TfS2ZYBD1T1HQMDe0OkCi+wUtwGdcFrXGTw3MG6ZuMqSizrFLsvl8PwK2g8s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.940.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0NqofhRDgtiV3KAskBAFud8gE6QAgd3eNuDpRR7BpF6tltJljbyVdFWccKIj/txM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.995.0/index.min.mjs": "sha384-0NqofhRDgtiV3KAskBAFud8gE6QAgd3eNuDpRR7BpF6tltJljbyVdFWccKIj/txM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.995.0/LICENSE
```

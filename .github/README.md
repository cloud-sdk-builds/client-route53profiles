...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-slpEVPB7yZgyE7wZhGk2L1Ua/26n9gKEKi7jQI2AVOxXM7NwcdFruoiTZbYld3NH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.816.0/index.min.mjs": "sha384-slpEVPB7yZgyE7wZhGk2L1Ua/26n9gKEKi7jQI2AVOxXM7NwcdFruoiTZbYld3NH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.816.0/LICENSE
```

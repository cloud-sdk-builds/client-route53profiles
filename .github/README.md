...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gSW4ur03GP1lBETi6BbsOe1LgoGjLFc3vXkR2byiHtcIv7q1oG2vhBjVqSIDUVCG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.968.0/index.min.mjs": "sha384-gSW4ur03GP1lBETi6BbsOe1LgoGjLFc3vXkR2byiHtcIv7q1oG2vhBjVqSIDUVCG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.968.0/LICENSE
```

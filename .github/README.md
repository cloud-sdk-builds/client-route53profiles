...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7+9uDOZsx32TQ/ma6Dep7zmGSCZyq7K2tQw0qKldrTyYjN61r3TQBBfRwdJEKlWl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.624.0/index.min.mjs": "sha384-7+9uDOZsx32TQ/ma6Dep7zmGSCZyq7K2tQw0qKldrTyYjN61r3TQBBfRwdJEKlWl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.624.0/LICENSE
```

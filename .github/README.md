...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MqZYG4mDN1JJSsJNAdsG8oVv+VH0folOdjbevBFxWH0qTM9u51mbeF0vXmECEG6v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.989.0/index.min.mjs": "sha384-MqZYG4mDN1JJSsJNAdsG8oVv+VH0folOdjbevBFxWH0qTM9u51mbeF0vXmECEG6v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.989.0/LICENSE
```

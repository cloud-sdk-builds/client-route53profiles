...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U09UGSgOvL9hO/gW8J1DziYxNIurXUTFUU31ZfuKszHyXGsts+PlbSpCQhY86RIK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.972.0/index.min.mjs": "sha384-U09UGSgOvL9hO/gW8J1DziYxNIurXUTFUU31ZfuKszHyXGsts+PlbSpCQhY86RIK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.972.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u5bcXEnMp/hUQA3+1cpBgCKSP0hOb8fAZ9Fgn/iGzO/lmLk5UNRJFtr6rTZ0LyMP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.808.0/index.min.mjs": "sha384-u5bcXEnMp/hUQA3+1cpBgCKSP0hOb8fAZ9Fgn/iGzO/lmLk5UNRJFtr6rTZ0LyMP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.808.0/LICENSE
```

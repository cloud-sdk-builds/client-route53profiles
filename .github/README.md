...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XaPJzgEoGa6N0Br4tWAHMR6DtnDDvtBTkAj3ZrRGg9kMQvfFaWB5qY+12w/4zq//
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.699.0/index.min.mjs": "sha384-XaPJzgEoGa6N0Br4tWAHMR6DtnDDvtBTkAj3ZrRGg9kMQvfFaWB5qY+12w/4zq//"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.699.0/LICENSE
```

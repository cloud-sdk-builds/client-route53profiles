...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-70y8eGmeAeRZHRkKIjVxGkANuFQLLlwn+oHVnd5V+8/9X37YdxbkmDJ/kzQgbG0L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.687.0/index.min.mjs": "sha384-70y8eGmeAeRZHRkKIjVxGkANuFQLLlwn+oHVnd5V+8/9X37YdxbkmDJ/kzQgbG0L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.687.0/LICENSE
```

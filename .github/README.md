...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JkCOxW4yqqbe7JZRCcSS+Gty0yjHPHYIAAAUl+qo1a0nRNFfiHYfW5HebNNFuNns
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.956.0/index.min.mjs": "sha384-JkCOxW4yqqbe7JZRCcSS+Gty0yjHPHYIAAAUl+qo1a0nRNFfiHYfW5HebNNFuNns"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.956.0/LICENSE
```

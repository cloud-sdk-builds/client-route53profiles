...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.674.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.674.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IYxR21vl2foPz/73jl4eWu5mKDDd8CsI/B6kzpXLW5niuhCoV4HkKMxDHUZwq0BL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.674.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.674.0/index.min.mjs": "sha384-IYxR21vl2foPz/73jl4eWu5mKDDd8CsI/B6kzpXLW5niuhCoV4HkKMxDHUZwq0BL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.674.0/LICENSE
```

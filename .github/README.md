...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aGmfTuhLGbECracE+UQuD7GMJhxdjKecG7WauMWRYt+Mj/UHN1+T6C9v1ooBbwlW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.592.0/index.min.mjs": "sha384-aGmfTuhLGbECracE+UQuD7GMJhxdjKecG7WauMWRYt+Mj/UHN1+T6C9v1ooBbwlW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.592.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1037.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1037.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-obJdXRXYvaf0AyhsdRZCQNvQtml0qeikuC4g/PTsgzxXXw7C2Re+syoK6Ogb0nyd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1037.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1037.0/index.min.mjs": "sha384-obJdXRXYvaf0AyhsdRZCQNvQtml0qeikuC4g/PTsgzxXXw7C2Re+syoK6Ogb0nyd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1037.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-clKiXugZalC9SeOOfWM6/aJqhw20Pi15ZDq97e9+UyiPdKPmN3ClTx456io+eA7h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.670.0/index.min.mjs": "sha384-clKiXugZalC9SeOOfWM6/aJqhw20Pi15ZDq97e9+UyiPdKPmN3ClTx456io+eA7h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.670.0/LICENSE
```

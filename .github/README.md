...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n59Y6qRLqQ72QTBxu+vcQM85i0Bcd+DBco3nTIbk11K1YLAfQSyHn9g5EWK0izfj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.798.0/index.min.mjs": "sha384-n59Y6qRLqQ72QTBxu+vcQM85i0Bcd+DBco3nTIbk11K1YLAfQSyHn9g5EWK0izfj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.798.0/LICENSE
```

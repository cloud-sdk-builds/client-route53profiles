...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vY6g6OTkR5hYoxrRGKh9wbwM2OrMCS1sl27wRi9jLpFaNrVjXYFILGRfjpFWbDyo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.826.0/index.min.mjs": "sha384-vY6g6OTkR5hYoxrRGKh9wbwM2OrMCS1sl27wRi9jLpFaNrVjXYFILGRfjpFWbDyo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.826.0/LICENSE
```

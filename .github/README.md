...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TaNEb7lF440FJc7qOaZM78RDnVuftgIQQ10q3Lx+pOiumJaBMYKw5kvWF1DvxI/E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.939.0/index.min.mjs": "sha384-TaNEb7lF440FJc7qOaZM78RDnVuftgIQQ10q3Lx+pOiumJaBMYKw5kvWF1DvxI/E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.939.0/LICENSE
```

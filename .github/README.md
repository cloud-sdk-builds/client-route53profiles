...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r7pfR35In1QhrE8QeHUzAV0xZuujUnLvchYjvG0ftUbSynuVx47qQw+2Wj2p66by
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.953.0/index.min.mjs": "sha384-r7pfR35In1QhrE8QeHUzAV0xZuujUnLvchYjvG0ftUbSynuVx47qQw+2Wj2p66by"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.953.0/LICENSE
```

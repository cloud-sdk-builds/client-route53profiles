...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R7COMxNdq7yuub4xRP70/D8XYeULFACIU9RbhQyLGe9TdZ9PpITC18/kYwPK7EaL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.799.0/index.min.mjs": "sha384-R7COMxNdq7yuub4xRP70/D8XYeULFACIU9RbhQyLGe9TdZ9PpITC18/kYwPK7EaL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.799.0/LICENSE
```

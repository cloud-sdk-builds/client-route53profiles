...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BigAJG706txT1hPHdv3wzVaasMVs5wQaEHTQ3MpAj5OxVmNo/F47VP44S1s+wx10
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.957.0/index.min.mjs": "sha384-BigAJG706txT1hPHdv3wzVaasMVs5wQaEHTQ3MpAj5OxVmNo/F47VP44S1s+wx10"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.957.0/LICENSE
```

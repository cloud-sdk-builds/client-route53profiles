...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3P+jMzBV181FdhdW6KHCCs9WnDw4d4d8AqLdNQ2yP1yZeGkzhVbULTl09Eogerhe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.895.0/index.min.mjs": "sha384-3P+jMzBV181FdhdW6KHCCs9WnDw4d4d8AqLdNQ2yP1yZeGkzhVbULTl09Eogerhe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.895.0/LICENSE
```

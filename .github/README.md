...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n0T/Lg5KhvDUiexhEaBIVkMH0jdG2KVv0tHPoz8AOdYFAHf6ZPT9KVLixJnU8E5s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.750.0/index.min.mjs": "sha384-n0T/Lg5KhvDUiexhEaBIVkMH0jdG2KVv0tHPoz8AOdYFAHf6ZPT9KVLixJnU8E5s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.750.0/LICENSE
```

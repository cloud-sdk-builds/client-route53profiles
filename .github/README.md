...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZXbbdhk1R8nKgS38YoOjucky0xsIPJMDaUyxKcnoickFM+LVwQuE9q6/0GZOd6qM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.574.0/index.min.mjs": "sha384-ZXbbdhk1R8nKgS38YoOjucky0xsIPJMDaUyxKcnoickFM+LVwQuE9q6/0GZOd6qM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.574.0/LICENSE
```

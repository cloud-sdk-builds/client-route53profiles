...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KILYZKRUPQtYnAY4LoRKl0iXNdnJ3BHq6KagYYkYbVv4ioZD+GFkZtBn28e2FVoL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.917.0/index.min.mjs": "sha384-KILYZKRUPQtYnAY4LoRKl0iXNdnJ3BHq6KagYYkYbVv4ioZD+GFkZtBn28e2FVoL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.917.0/LICENSE
```

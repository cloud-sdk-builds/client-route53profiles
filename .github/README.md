...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y/GZJyg4WJ59LcYV3d70dtSfg/rKJitB9V6Pfp/rHs5g+slcIf4uxhZ8DbwbcehU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.582.0/index.min.mjs": "sha384-y/GZJyg4WJ59LcYV3d70dtSfg/rKJitB9V6Pfp/rHs5g+slcIf4uxhZ8DbwbcehU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.582.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vnhRhCzVkbsMOPky2QwrAgBRdooLa/mt69WFCNubj4RCe7j5u9P3xtN3bftX24Pi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.975.0/index.min.mjs": "sha384-vnhRhCzVkbsMOPky2QwrAgBRdooLa/mt69WFCNubj4RCe7j5u9P3xtN3bftX24Pi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.975.0/LICENSE
```

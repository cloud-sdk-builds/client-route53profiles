...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1032.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1032.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v/KnuCaxg5UM/2Ch2EOv9iRV30EvYGZA6HTUjuk9i5txSNHLBzT2i+sXJ3X5pQIw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1032.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1032.0/index.min.mjs": "sha384-v/KnuCaxg5UM/2Ch2EOv9iRV30EvYGZA6HTUjuk9i5txSNHLBzT2i+sXJ3X5pQIw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1032.0/LICENSE
```

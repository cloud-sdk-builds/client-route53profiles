...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0hMYJ6CscRc5c6edmYp8FROnABbIPxNH4YU5t1IsVaMxTieWs1Tg/rdHpqqdp+66
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.967.0/index.min.mjs": "sha384-0hMYJ6CscRc5c6edmYp8FROnABbIPxNH4YU5t1IsVaMxTieWs1Tg/rdHpqqdp+66"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.967.0/LICENSE
```

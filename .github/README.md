...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TcuNN6zVWUCc/xBPMvqgi/lZjy7BkA9/PnClcui/xxq0txTG6GEmmZQpnt402hmN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.948.0/index.min.mjs": "sha384-TcuNN6zVWUCc/xBPMvqgi/lZjy7BkA9/PnClcui/xxq0txTG6GEmmZQpnt402hmN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.948.0/LICENSE
```

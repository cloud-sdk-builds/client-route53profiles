...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1020.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1020.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F4DDhBL1i6+pvG7TIkWm0CIpTyekIHpyw63/1Y66s3/56hh/aXJGkdGBw6qcsbtD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1020.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1020.0/index.min.mjs": "sha384-F4DDhBL1i6+pvG7TIkWm0CIpTyekIHpyw63/1Y66s3/56hh/aXJGkdGBw6qcsbtD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1020.0/LICENSE
```

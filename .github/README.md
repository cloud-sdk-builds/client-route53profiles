...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S59GT9i5poQu4dckby59+fKa7vq0X6v5PIIJLQl4Z9eFxBoAiiSOdsRRd3GzKiRa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.946.0/index.min.mjs": "sha384-S59GT9i5poQu4dckby59+fKa7vq0X6v5PIIJLQl4Z9eFxBoAiiSOdsRRd3GzKiRa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.946.0/LICENSE
```

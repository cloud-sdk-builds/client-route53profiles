...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-627/bLgLzE/sKPgTHZbiqKATUrVq+9OYMpbpCyXJBGzMAIFC+V+S8v8WTCVSu6WT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.888.0/index.min.mjs": "sha384-627/bLgLzE/sKPgTHZbiqKATUrVq+9OYMpbpCyXJBGzMAIFC+V+S8v8WTCVSu6WT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.888.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5jXFvEDv5gUNrMbwaHEI7OJ8X0o/RLC4Fn7yLATiZUFqS8brrdtqZJXqk09FpjmP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.987.0/index.min.mjs": "sha384-5jXFvEDv5gUNrMbwaHEI7OJ8X0o/RLC4Fn7yLATiZUFqS8brrdtqZJXqk09FpjmP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.987.0/LICENSE
```

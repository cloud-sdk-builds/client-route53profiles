...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TSWOJUn3Li4W26N0TQr1fLFNX7qiGY0lhkVLO936Ugi8v+d6zcB+KdG+jC3+d/5L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.934.0/index.min.mjs": "sha384-TSWOJUn3Li4W26N0TQr1fLFNX7qiGY0lhkVLO936Ugi8v+d6zcB+KdG+jC3+d/5L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.934.0/LICENSE
```

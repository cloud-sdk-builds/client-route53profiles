...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wu3GmqoHqFUPKB9+a4pBSyhTGKLse2S89CwE63ajuQNDVCRKk1kZd0ghyvQJgEKw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.920.0/index.min.mjs": "sha384-Wu3GmqoHqFUPKB9+a4pBSyhTGKLse2S89CwE63ajuQNDVCRKk1kZd0ghyvQJgEKw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.920.0/LICENSE
```

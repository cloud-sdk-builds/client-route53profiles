...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dcaplC3B9Fag0rniAvylr/gIS3XcOYnWxOrhoIJaG+r6SQJ0Oe0nr0jrRefVDmbp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.907.0/index.min.mjs": "sha384-dcaplC3B9Fag0rniAvylr/gIS3XcOYnWxOrhoIJaG+r6SQJ0Oe0nr0jrRefVDmbp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.907.0/LICENSE
```

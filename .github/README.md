...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JgbGZW2mRu+ZtJCBRWfzXLJU3WjHMt4Y4Q6eiVwXuE3q6+mSDgrKHxfIUPc/PJc5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.981.0/index.min.mjs": "sha384-JgbGZW2mRu+ZtJCBRWfzXLJU3WjHMt4Y4Q6eiVwXuE3q6+mSDgrKHxfIUPc/PJc5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.981.0/LICENSE
```

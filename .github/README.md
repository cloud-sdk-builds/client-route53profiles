...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9KWU5hxvgNJV+kQFZ6r2AT0BO6LEYw44z5Lamzbde3h9r6hUsYNakBGgoc0qrZ6l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.964.0/index.min.mjs": "sha384-9KWU5hxvgNJV+kQFZ6r2AT0BO6LEYw44z5Lamzbde3h9r6hUsYNakBGgoc0qrZ6l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.964.0/LICENSE
```

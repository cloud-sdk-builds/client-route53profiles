...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DcUyfdl+TGvC41/cPUVNspjso1eANcntm2+fbuw7kXAca85POED6YW7cIA8rwv46
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.782.0/index.min.mjs": "sha384-DcUyfdl+TGvC41/cPUVNspjso1eANcntm2+fbuw7kXAca85POED6YW7cIA8rwv46"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.782.0/LICENSE
```

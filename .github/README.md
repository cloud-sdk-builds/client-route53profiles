...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WH/3ElUhNXLHJfz1AeXRgIZcaUQSvBP2IZu2oa1ldl0Yza6wXKdDA+JiGjDVBNho
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1041.0/index.min.mjs": "sha384-WH/3ElUhNXLHJfz1AeXRgIZcaUQSvBP2IZu2oa1ldl0Yza6wXKdDA+JiGjDVBNho"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1041.0/LICENSE
```

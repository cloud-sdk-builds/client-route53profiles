...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IWlJS89UoJLMduityd0NB0RvO1evuqxgJqTx8m14bZtqytrICxT38ALGwRAUpfHQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.943.0/index.min.mjs": "sha384-IWlJS89UoJLMduityd0NB0RvO1evuqxgJqTx8m14bZtqytrICxT38ALGwRAUpfHQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.943.0/LICENSE
```

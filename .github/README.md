...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XZT4bDywMfMW38hqazb6xZv5uJ613f+t0mNMm/SPO3FOaP2SZl1GgyjW0xB9Ubob
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.714.0/index.min.mjs": "sha384-XZT4bDywMfMW38hqazb6xZv5uJ613f+t0mNMm/SPO3FOaP2SZl1GgyjW0xB9Ubob"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.714.0/LICENSE
```

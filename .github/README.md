...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7A1GscStK2FrJ5HLAjFIo/xK60gW4zW0Sl6f2aC1dfgxGTKK7BqJWDSUcZ0fneXE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.926.0/index.min.mjs": "sha384-7A1GscStK2FrJ5HLAjFIo/xK60gW4zW0Sl6f2aC1dfgxGTKK7BqJWDSUcZ0fneXE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.926.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z5WqKJUOMQ8U+5aN6cDGob9+66J63heMxdWoQvUK3eLXGzM+su0Cate9yk1vIcIe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.848.0/index.min.mjs": "sha384-Z5WqKJUOMQ8U+5aN6cDGob9+66J63heMxdWoQvUK3eLXGzM+su0Cate9yk1vIcIe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.848.0/LICENSE
```

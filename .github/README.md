...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rnicliNpzimAZPvF9GKs/6maYnnMfNnswXCn3PkiIlmUkyCZ9ggNsIywnZl/90vL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.588.0/index.min.mjs": "sha384-rnicliNpzimAZPvF9GKs/6maYnnMfNnswXCn3PkiIlmUkyCZ9ggNsIywnZl/90vL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.588.0/LICENSE
```

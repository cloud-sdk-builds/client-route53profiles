...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ADhT4pFAaP82SLKEK2UyQ6OM9hoNpIZW1e7k+YWLXuGDQia48vigQJCAfR45mVEd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.796.0/index.min.mjs": "sha384-ADhT4pFAaP82SLKEK2UyQ6OM9hoNpIZW1e7k+YWLXuGDQia48vigQJCAfR45mVEd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.796.0/LICENSE
```

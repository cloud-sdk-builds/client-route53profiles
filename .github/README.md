...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SAjcN0PgKOUkGxrmy2uz19UH7/0ZFPVSkrmqRKoYv5VJPn/he2UVgtg4JRrojeDM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.596.0/index.min.mjs": "sha384-SAjcN0PgKOUkGxrmy2uz19UH7/0ZFPVSkrmqRKoYv5VJPn/he2UVgtg4JRrojeDM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.596.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qy56zGmtv8mhVW1Bd7qaB6EIcs7biOCjqvqBM34ZD4cvpsix/NCWD/UmoCEUlhl8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.846.0/index.min.mjs": "sha384-qy56zGmtv8mhVW1Bd7qaB6EIcs7biOCjqvqBM34ZD4cvpsix/NCWD/UmoCEUlhl8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.846.0/LICENSE
```

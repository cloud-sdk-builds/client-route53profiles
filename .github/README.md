...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-byh0Qy66n69X+UacuNuZBBR1yWQpytKZu+2z70kulDIDsNtNc3ep9JwrCJ+eU0bP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.662.0/index.min.mjs": "sha384-byh0Qy66n69X+UacuNuZBBR1yWQpytKZu+2z70kulDIDsNtNc3ep9JwrCJ+eU0bP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.662.0/LICENSE
```

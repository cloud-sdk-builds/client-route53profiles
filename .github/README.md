...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r95JinPcLN8dOqrI2Lss5QWZaJHZzGsEUfBZnjuD3Z9c9yYqruvBway5QWjceJFW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.803.0/index.min.mjs": "sha384-r95JinPcLN8dOqrI2Lss5QWZaJHZzGsEUfBZnjuD3Z9c9yYqruvBway5QWjceJFW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.803.0/LICENSE
```

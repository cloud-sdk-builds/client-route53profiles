...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gf91HMekPgsaW8vzl0HFa1BqBh+adlKr4EIQhTAy4fdupHE+UqSJnooWP0zE/VsX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.958.0/index.min.mjs": "sha384-gf91HMekPgsaW8vzl0HFa1BqBh+adlKr4EIQhTAy4fdupHE+UqSJnooWP0zE/VsX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.958.0/LICENSE
```

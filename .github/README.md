...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gk+JDvrDDUrG6uPMuBogbPYAby0srjBdLgoryPQaBhlONAyAD3sATH8DkRASiAWD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.810.0/index.min.mjs": "sha384-Gk+JDvrDDUrG6uPMuBogbPYAby0srjBdLgoryPQaBhlONAyAD3sATH8DkRASiAWD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.810.0/LICENSE
```

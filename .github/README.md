...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p2y7iF5YQbf39DjcyHxMzm5+/CyakCxhS4jNzFtybIrifzV8ULbG05n41PsCcuqt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.855.0/index.min.mjs": "sha384-p2y7iF5YQbf39DjcyHxMzm5+/CyakCxhS4jNzFtybIrifzV8ULbG05n41PsCcuqt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.855.0/LICENSE
```

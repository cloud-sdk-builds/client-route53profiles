...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V+tGXLeieCM6QYdiczvtij0dUiXXMkU0niuiEFZRO/dgy/hNdwE9H2l6s8FrT3c3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.910.0/index.min.mjs": "sha384-V+tGXLeieCM6QYdiczvtij0dUiXXMkU0niuiEFZRO/dgy/hNdwE9H2l6s8FrT3c3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.910.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4803m1OXGKcDlek81VN5jIyXvUY0eJusPfwOPtL+cBNiNipxhXEz+qM+nfoXJlDf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.712.0/index.min.mjs": "sha384-4803m1OXGKcDlek81VN5jIyXvUY0eJusPfwOPtL+cBNiNipxhXEz+qM+nfoXJlDf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.712.0/LICENSE
```

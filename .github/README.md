...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-azLCG5kmNs2F5s/18zi352i3PUxswT6jKXwzfrtqI3t0GJb091Z4Xp5HR+qQOZvE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.563.0/index.min.mjs": "sha384-azLCG5kmNs2F5s/18zi352i3PUxswT6jKXwzfrtqI3t0GJb091Z4Xp5HR+qQOZvE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.563.0/LICENSE
```

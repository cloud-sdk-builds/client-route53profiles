...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O1Mtu3IXgOMgoolCe8yOvq0vlafhHmf5Wret8+r7qi/y+iDcBrkmPEGUwIeifwiL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.992.0/index.min.mjs": "sha384-O1Mtu3IXgOMgoolCe8yOvq0vlafhHmf5Wret8+r7qi/y+iDcBrkmPEGUwIeifwiL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.992.0/LICENSE
```

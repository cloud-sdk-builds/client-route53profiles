...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HiR8h+LKOC2fOsUqh7c54iTYFHXLKQ7z76/LFhw8G0WGwRyQ2GcQxLPjtn7KiDwV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.777.0/index.min.mjs": "sha384-HiR8h+LKOC2fOsUqh7c54iTYFHXLKQ7z76/LFhw8G0WGwRyQ2GcQxLPjtn7KiDwV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.777.0/LICENSE
```

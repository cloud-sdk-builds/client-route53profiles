...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hdGDbU+mX80zemkMjbAAksqbfz0eMkYLEbijuQViQyHBFOe6Gq0X+f3vQhVoxTPk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.894.0/index.min.mjs": "sha384-hdGDbU+mX80zemkMjbAAksqbfz0eMkYLEbijuQViQyHBFOe6Gq0X+f3vQhVoxTPk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.894.0/LICENSE
```

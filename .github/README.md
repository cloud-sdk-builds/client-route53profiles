...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bdqaJK2eoS9Bx5FXouQ8+wRWASFGv9j8+D+absoN796rj0RX6va+A1WNVd7pIlK+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.569.0/index.min.mjs": "sha384-bdqaJK2eoS9Bx5FXouQ8+wRWASFGv9j8+D+absoN796rj0RX6va+A1WNVd7pIlK+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.569.0/LICENSE
```

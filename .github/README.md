...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-odSrJ5mJgS/sNKKPWJiHsPL6mu1NaOik6iq/bL0qm/tUuumEmUjA72GHWCkYXtPg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.629.0/index.min.mjs": "sha384-odSrJ5mJgS/sNKKPWJiHsPL6mu1NaOik6iq/bL0qm/tUuumEmUjA72GHWCkYXtPg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.629.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OLVXu3kDmxZ13x1FpZmTJhtOhp2IPDy3pp2Mtm72khgGhP1kzXBvdVksrfj0Nnhd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.947.0/index.min.mjs": "sha384-OLVXu3kDmxZ13x1FpZmTJhtOhp2IPDy3pp2Mtm72khgGhP1kzXBvdVksrfj0Nnhd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.947.0/LICENSE
```

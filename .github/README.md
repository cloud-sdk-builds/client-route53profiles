...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WI9iFnfVGwxwMGYmqCdJ6uxh8eeejbfA/ufWCK9VcT6KRyG6RohRi4kNwweopiNC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.738.0/index.min.mjs": "sha384-WI9iFnfVGwxwMGYmqCdJ6uxh8eeejbfA/ufWCK9VcT6KRyG6RohRi4kNwweopiNC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.738.0/LICENSE
```

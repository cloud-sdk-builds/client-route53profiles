...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-slz6STzAS16vum22OHwI65nESEBBMuDqEUa9PSj+7z2nuImMZBIxZ0A76vP41tBN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.645.0/index.min.mjs": "sha384-slz6STzAS16vum22OHwI65nESEBBMuDqEUa9PSj+7z2nuImMZBIxZ0A76vP41tBN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.645.0/LICENSE
```

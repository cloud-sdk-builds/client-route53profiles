...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GsUOm6PXvygQg7dZHipqajypLuKGT/h1FHOw0iDSzsGs8GxepsufkO5kyOC0QDvR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.890.0/index.min.mjs": "sha384-GsUOm6PXvygQg7dZHipqajypLuKGT/h1FHOw0iDSzsGs8GxepsufkO5kyOC0QDvR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.890.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1028.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1028.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OguuufzFV78s0x34RKD7H3N9dowED/3EiohYA4lRzcNCij/P2eU+TJBKQNUYtlte
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1028.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1028.0/index.min.mjs": "sha384-OguuufzFV78s0x34RKD7H3N9dowED/3EiohYA4lRzcNCij/P2eU+TJBKQNUYtlte"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1028.0/LICENSE
```

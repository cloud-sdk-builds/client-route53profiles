...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5fb4LEf50QR5Ly17eKwdbFguxmBfaJthZjIdHfkfBWneJrXz6gsZpgIqVKv0Rjlv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.988.0/index.min.mjs": "sha384-5fb4LEf50QR5Ly17eKwdbFguxmBfaJthZjIdHfkfBWneJrXz6gsZpgIqVKv0Rjlv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.988.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gG6QNFpQbX6yLoGQX2cj1zo7jDH/8QnKkaHmKQSF3MJRE3ED6qqdtOGCvukZBkS/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.887.0/index.min.mjs": "sha384-gG6QNFpQbX6yLoGQX2cj1zo7jDH/8QnKkaHmKQSF3MJRE3ED6qqdtOGCvukZBkS/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.887.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-7j592scVILKZTGbP9DobirzaMGUsQ3s+I7DbNboEvk1Igqs62Wx1sQqjcpVApK8S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.620.1/index.min.mjs": "sha384-7j592scVILKZTGbP9DobirzaMGUsQ3s+I7DbNboEvk1Igqs62Wx1sQqjcpVApK8S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.620.1/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wu9PnGY/O6T7VEeG8/w5+NIZwyCSQYdAjLt56R/Pg9jiwZW/HE2mcqHucx3nwLHI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.675.0/index.min.mjs": "sha384-Wu9PnGY/O6T7VEeG8/w5+NIZwyCSQYdAjLt56R/Pg9jiwZW/HE2mcqHucx3nwLHI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.675.0/LICENSE
```

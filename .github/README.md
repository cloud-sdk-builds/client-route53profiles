...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5UMvG7ETlBkuYa/aMQCrqFnnaL7HZW8J3V+uPv4Guv+byxbISqWdKb+kY9q/lFD8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.575.0/index.min.mjs": "sha384-5UMvG7ETlBkuYa/aMQCrqFnnaL7HZW8J3V+uPv4Guv+byxbISqWdKb+kY9q/lFD8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.575.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tzpLWLOtNED9I9eAh66eMJPM+dmtlfiBDjMH8L0h83FgXyZXIjQ10UuZ1SuXg9MA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.744.0/index.min.mjs": "sha384-tzpLWLOtNED9I9eAh66eMJPM+dmtlfiBDjMH8L0h83FgXyZXIjQ10UuZ1SuXg9MA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.744.0/LICENSE
```

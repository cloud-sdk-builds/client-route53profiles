...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tCIP3i/QeLCIByaBRn/S2k9ilXlde916sGAK7bRs2mBmEiHymRF6uFe1OoaElRfw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.882.0/index.min.mjs": "sha384-tCIP3i/QeLCIByaBRn/S2k9ilXlde916sGAK7bRs2mBmEiHymRF6uFe1OoaElRfw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.882.0/LICENSE
```

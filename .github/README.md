...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kmUp9CMG7LayMOMcOv9hyFSpJGGrYJSREogJ21rkz5j3lONENI8UNz9WoFF7sDLd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.872.0/index.min.mjs": "sha384-kmUp9CMG7LayMOMcOv9hyFSpJGGrYJSREogJ21rkz5j3lONENI8UNz9WoFF7sDLd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.872.0/LICENSE
```

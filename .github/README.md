...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F1h/G2SblxeI0Ae98bdulPbr052cn//DAzmpGWQqaqhSuErw2a0+PzQsNlhEUwBt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.997.0/index.min.mjs": "sha384-F1h/G2SblxeI0Ae98bdulPbr052cn//DAzmpGWQqaqhSuErw2a0+PzQsNlhEUwBt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.997.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vQ3046Elbn8wSURDYrhfpLtbUIEYw6ewQAzYiNfPTkYtvcqsUd/vo4QrNqseP/6w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.743.0/index.min.mjs": "sha384-vQ3046Elbn8wSURDYrhfpLtbUIEYw6ewQAzYiNfPTkYtvcqsUd/vo4QrNqseP/6w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.743.0/LICENSE
```

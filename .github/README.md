...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w5W+hiOQ2ooqSmJ376MW6hbLFth2nP5CXqchVbvi0iKDQCL7dimrVezu8aCnJenY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.616.0/index.min.mjs": "sha384-w5W+hiOQ2ooqSmJ376MW6hbLFth2nP5CXqchVbvi0iKDQCL7dimrVezu8aCnJenY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.616.0/LICENSE
```

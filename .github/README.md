...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ra0ZB6T8kCGvdNwVuLzL28q+SwXp85Aj5w7TJiopAiyuuzRx9yBrRFiB+Ae7Bs6j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.996.0/index.min.mjs": "sha384-ra0ZB6T8kCGvdNwVuLzL28q+SwXp85Aj5w7TJiopAiyuuzRx9yBrRFiB+Ae7Bs6j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.996.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RGOKd2e0pNG6A+CLj3Q8KBBulaSg/TLbS13Z5uFBsjYNna+uVbWh0JmAxj+iEbjW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.693.0/index.min.mjs": "sha384-RGOKd2e0pNG6A+CLj3Q8KBBulaSg/TLbS13Z5uFBsjYNna+uVbWh0JmAxj+iEbjW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.693.0/LICENSE
```

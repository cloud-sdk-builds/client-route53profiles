...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5eqKUOd1yqEmZpoEaMv2l+aXmgd46UxflOl7ylnRznQlsUiHBWt2q9TFcMbCpFzK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.667.0/index.min.mjs": "sha384-5eqKUOd1yqEmZpoEaMv2l+aXmgd46UxflOl7ylnRznQlsUiHBWt2q9TFcMbCpFzK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.667.0/LICENSE
```

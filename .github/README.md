...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3gE1xrCGY73IHUwwDGjt2V5qQ+n3vOxWndLhtaS0K9DIsztp9U4s3iog7LsgRVpz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.876.0/index.min.mjs": "sha384-3gE1xrCGY73IHUwwDGjt2V5qQ+n3vOxWndLhtaS0K9DIsztp9U4s3iog7LsgRVpz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.876.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aJZ0w2QLtk1Oqj1WAA9oOhDQI9/RNiS/ttlnBZ6ZrtGkJ9e9kB/+Cm3SeDkljzQx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.993.0/index.min.mjs": "sha384-aJZ0w2QLtk1Oqj1WAA9oOhDQI9/RNiS/ttlnBZ6ZrtGkJ9e9kB/+Cm3SeDkljzQx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.993.0/LICENSE
```

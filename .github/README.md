...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DJE4ATkeX943fRfU1iEC6fxDJBMCIIHoJmDOjq4Zy1ApWrrNxYnNRD4/eIM113nf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.666.0/index.min.mjs": "sha384-DJE4ATkeX943fRfU1iEC6fxDJBMCIIHoJmDOjq4Zy1ApWrrNxYnNRD4/eIM113nf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.666.0/LICENSE
```

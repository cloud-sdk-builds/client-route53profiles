...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VdAtdDgRV+DM0Q7J7d7elkfgJQXKJLaXEH0CjsA9z02KPgHD2d2AqH8PY6VMTkdT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.606.0/index.min.mjs": "sha384-VdAtdDgRV+DM0Q7J7d7elkfgJQXKJLaXEH0CjsA9z02KPgHD2d2AqH8PY6VMTkdT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.606.0/LICENSE
```

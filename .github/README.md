...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GEBF+vqOjD5Eo7JtUeyHydnPUGsg8TqwpP4r/wd2Gzi6RlEtb/xumz3jZgdCZm5T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.775.0/index.min.mjs": "sha384-GEBF+vqOjD5Eo7JtUeyHydnPUGsg8TqwpP4r/wd2Gzi6RlEtb/xumz3jZgdCZm5T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.775.0/LICENSE
```

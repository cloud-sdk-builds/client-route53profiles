...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1003.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1003.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BDr0l8ixEx97yueaDr6OswVzdlQFxGVFVEzwBt/uYzbn0XMYsnhtVCVj1gwDXFbU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1003.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1003.0/index.min.mjs": "sha384-BDr0l8ixEx97yueaDr6OswVzdlQFxGVFVEzwBt/uYzbn0XMYsnhtVCVj1gwDXFbU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1003.0/LICENSE
```

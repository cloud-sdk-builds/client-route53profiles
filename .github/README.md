...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/Qf11jnrW8YPn2CJO+TYw6fLcTxYciIxsexEpNec3ZK6JPNtTU82jUs3iRADZXjL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.928.0/index.min.mjs": "sha384-/Qf11jnrW8YPn2CJO+TYw6fLcTxYciIxsexEpNec3ZK6JPNtTU82jUs3iRADZXjL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.928.0/LICENSE
```

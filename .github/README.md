...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1/coXZaXB8d4dWZleNLFHq2RwPyv+MwL2l7Qh8c+UXw+dCzhQMnABah5O3HQi5CN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.966.0/index.min.mjs": "sha384-1/coXZaXB8d4dWZleNLFHq2RwPyv+MwL2l7Qh8c+UXw+dCzhQMnABah5O3HQi5CN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.966.0/LICENSE
```

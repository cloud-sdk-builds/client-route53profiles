...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fraJJmgch0qo0zGUznQef06/s0KRDlAOuuUY75tTM8gBJYqs/o2ZhLefeLaRWtLG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1033.0/index.min.mjs": "sha384-fraJJmgch0qo0zGUznQef06/s0KRDlAOuuUY75tTM8gBJYqs/o2ZhLefeLaRWtLG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1033.0/LICENSE
```

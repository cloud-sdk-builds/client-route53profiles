...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ltIfECpJR33Q1Iu7w+t83xT+pYiMkBM1DQs7eiB7nPkLyAL3qyuO31kPwdlkB9Rd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.925.0/index.min.mjs": "sha384-ltIfECpJR33Q1Iu7w+t83xT+pYiMkBM1DQs7eiB7nPkLyAL3qyuO31kPwdlkB9Rd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.925.0/LICENSE
```

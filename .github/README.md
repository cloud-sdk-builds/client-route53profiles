...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+jl+0HBNXPMBNzDYaSw5n/DQr2LKZCxl4M/nqeK18Spon8PNUSQdyTFEdNClXcQu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.709.0/index.min.mjs": "sha384-+jl+0HBNXPMBNzDYaSw5n/DQr2LKZCxl4M/nqeK18Spon8PNUSQdyTFEdNClXcQu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.709.0/LICENSE
```

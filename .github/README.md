...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YacZYiamTOB+7CuvchQcb2qa02oIPD+ZBtZjKIdbGonTQckm9nfC/bPxSt386Kh8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1039.0/index.min.mjs": "sha384-YacZYiamTOB+7CuvchQcb2qa02oIPD+ZBtZjKIdbGonTQckm9nfC/bPxSt386Kh8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1039.0/LICENSE
```

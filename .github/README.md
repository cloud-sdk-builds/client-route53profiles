...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+Bcm/mWpyRiv02NL0uh2R25V4RvEJEbbSElo8W/Bq6IEoc67ZPcmhU6GJMAVjPlt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.919.0/index.min.mjs": "sha384-+Bcm/mWpyRiv02NL0uh2R25V4RvEJEbbSElo8W/Bq6IEoc67ZPcmhU6GJMAVjPlt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.919.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hQBYooXXUKgAZIPRevUlMPeyS9I6d0N9Oa27g6PUa0/PAxEWnJzBclafdBqNXTBs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.806.0/index.min.mjs": "sha384-hQBYooXXUKgAZIPRevUlMPeyS9I6d0N9Oa27g6PUa0/PAxEWnJzBclafdBqNXTBs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.806.0/LICENSE
```

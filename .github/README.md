...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7/3sbZ1jKppi2BXHyQIwB6wFRwQUDdJY3vSYrqdYJZWxUxV7YcOlJ4pJ0vb2V9NE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.839.0/index.min.mjs": "sha384-7/3sbZ1jKppi2BXHyQIwB6wFRwQUDdJY3vSYrqdYJZWxUxV7YcOlJ4pJ0vb2V9NE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.839.0/LICENSE
```

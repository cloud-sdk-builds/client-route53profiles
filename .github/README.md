...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1029.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1029.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t8z9GuRA9wjuthuqAupzit1NXn+fTTiFxj83O8Eu62kSHi8lFeosbRFcog4C2O5e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1029.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1029.0/index.min.mjs": "sha384-t8z9GuRA9wjuthuqAupzit1NXn+fTTiFxj83O8Eu62kSHi8lFeosbRFcog4C2O5e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1029.0/LICENSE
```

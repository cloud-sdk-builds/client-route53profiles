...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-88hC6F6XVjw/9SKVkjnhd+fxhv9JulcBFVf3NeO5YqegOn7jaX6XPeClzFDdB43l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.731.0/index.min.mjs": "sha384-88hC6F6XVjw/9SKVkjnhd+fxhv9JulcBFVf3NeO5YqegOn7jaX6XPeClzFDdB43l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.731.0/LICENSE
```

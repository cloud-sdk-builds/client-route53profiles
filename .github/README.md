...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i7JJttyGDke2MkfxzVvbTpwmDU8za7Ltp48TtvGVY/Z20RaVLPPuSBlu3IyLJpmH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.623.0/index.min.mjs": "sha384-i7JJttyGDke2MkfxzVvbTpwmDU8za7Ltp48TtvGVY/Z20RaVLPPuSBlu3IyLJpmH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.623.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mv7sJiHseFQsZyLlKiOJA/MYXMlGdOmgsnh6O7fB7QA1PGZn5n9/gKItsKwCvHyn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.873.0/index.min.mjs": "sha384-Mv7sJiHseFQsZyLlKiOJA/MYXMlGdOmgsnh6O7fB7QA1PGZn5n9/gKItsKwCvHyn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.873.0/LICENSE
```

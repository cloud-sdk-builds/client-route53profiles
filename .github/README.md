...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mzWghith4NudvnXAVYO2+t4YBJBdSkeOUSz/YbhVrqC7B5NY0glhHudQZh4pF/C5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.564.0/index.min.mjs": "sha384-mzWghith4NudvnXAVYO2+t4YBJBdSkeOUSz/YbhVrqC7B5NY0glhHudQZh4pF/C5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.564.0/LICENSE
```

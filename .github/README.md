...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6owJ/xtFu1pMqzY/x338v1/b/HIwP/rHb+Rd/DvY2B75la+R765uevPpX7xs0O8z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.978.0/index.min.mjs": "sha384-6owJ/xtFu1pMqzY/x338v1/b/HIwP/rHb+Rd/DvY2B75la+R765uevPpX7xs0O8z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.978.0/LICENSE
```

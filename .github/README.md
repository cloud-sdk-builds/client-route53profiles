...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7peSllxTNjEMZiq+CJi2nU5Xr6OaoOW+4x9w4lE407c3cyxbZE3f+/Dhkg+FNK45
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.721.0/index.min.mjs": "sha384-7peSllxTNjEMZiq+CJi2nU5Xr6OaoOW+4x9w4lE407c3cyxbZE3f+/Dhkg+FNK45"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.721.0/LICENSE
```

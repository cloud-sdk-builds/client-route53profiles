...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K3nH2ZZmCXksg2CX4v/T/pdknzd42iMmz3dNH8xOkfywdmzGce1EcaQB8yS4g1LW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.844.0/index.min.mjs": "sha384-K3nH2ZZmCXksg2CX4v/T/pdknzd42iMmz3dNH8xOkfywdmzGce1EcaQB8yS4g1LW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.844.0/LICENSE
```

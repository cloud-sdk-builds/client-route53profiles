...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2Wj3ZaR5grNmVpdMl+VgJD43XbNb6+1lqecg+DfMDNhK2dynvZ/GR0gFjy7P+8Wv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.862.0/index.min.mjs": "sha384-2Wj3ZaR5grNmVpdMl+VgJD43XbNb6+1lqecg+DfMDNhK2dynvZ/GR0gFjy7P+8Wv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.862.0/LICENSE
```

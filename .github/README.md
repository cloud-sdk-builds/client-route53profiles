...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ih+p+Wmq9E7ZpJGJQXuZ/dwXPphFxUskBcU1AWxl7OCeBqdYL7kqp4Uj9ByJ6APT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.678.0/index.min.mjs": "sha384-Ih+p+Wmq9E7ZpJGJQXuZ/dwXPphFxUskBcU1AWxl7OCeBqdYL7kqp4Uj9ByJ6APT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.678.0/LICENSE
```

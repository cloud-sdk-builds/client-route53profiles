...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yUoqT1pgjz8CEdToffdV5m/VlYSThklwJ7//INU+j5pKI77sp2D0+q9TTYjzp6Xa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.620.0/index.min.mjs": "sha384-yUoqT1pgjz8CEdToffdV5m/VlYSThklwJ7//INU+j5pKI77sp2D0+q9TTYjzp6Xa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.620.0/LICENSE
```

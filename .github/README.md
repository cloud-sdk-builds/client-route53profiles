...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-FENh0TJ77G2YFx1fQdVqFazZyISHrAvjsEb6cTad5smuxy041E7CMZPPAhzRxqo1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.731.1/index.min.mjs": "sha384-FENh0TJ77G2YFx1fQdVqFazZyISHrAvjsEb6cTad5smuxy041E7CMZPPAhzRxqo1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.731.1/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J1Lu3XaouQIz8obq0T6vklbijPer2RWs5nTVfR80SvRDOPzWesZntZ9mDr/fCu7S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.825.0/index.min.mjs": "sha384-J1Lu3XaouQIz8obq0T6vklbijPer2RWs5nTVfR80SvRDOPzWesZntZ9mDr/fCu7S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.825.0/LICENSE
```

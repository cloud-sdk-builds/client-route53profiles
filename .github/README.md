...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C1slzq14Nl+LksYXcgu6JntIMs4Sr/1Ei8AQhlyPbctQuq5oN5U+XPkW8rDoZcFE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.637.0/index.min.mjs": "sha384-C1slzq14Nl+LksYXcgu6JntIMs4Sr/1Ei8AQhlyPbctQuq5oN5U+XPkW8rDoZcFE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.637.0/LICENSE
```

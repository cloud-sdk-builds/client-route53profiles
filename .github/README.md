...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qWzp+kSlvNH6hajOp3a9PZ/MDPD1AqA8+BmW6hqg2a/Ql8P2aqUurq+OIog8aUH6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.734.0/index.min.mjs": "sha384-qWzp+kSlvNH6hajOp3a9PZ/MDPD1AqA8+BmW6hqg2a/Ql8P2aqUurq+OIog8aUH6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.734.0/LICENSE
```

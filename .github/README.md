...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-67HT55NiHVvvV9bPRWzMpHid05GGzl6HdnVbl5x6/yGwLvKUoyjzUyUsJD3ltlE2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.965.0/index.min.mjs": "sha384-67HT55NiHVvvV9bPRWzMpHid05GGzl6HdnVbl5x6/yGwLvKUoyjzUyUsJD3ltlE2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.965.0/LICENSE
```

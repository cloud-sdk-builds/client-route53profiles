...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cdtRD72j7Kygd/f3I7f9fDWxqmoeXcSmXErg3i7MBX9SMhQAhfvKgdIlb4Y4XSVl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.576.0/index.min.mjs": "sha384-cdtRD72j7Kygd/f3I7f9fDWxqmoeXcSmXErg3i7MBX9SMhQAhfvKgdIlb4Y4XSVl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.576.0/LICENSE
```

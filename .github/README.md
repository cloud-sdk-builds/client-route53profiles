...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s8lWYMeZVWcd+H929JtsTDqi8Y1y3e9F3RGdFfLXe6zyRPjV/qYXXkgwXHWEjTEU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.971.0/index.min.mjs": "sha384-s8lWYMeZVWcd+H929JtsTDqi8Y1y3e9F3RGdFfLXe6zyRPjV/qYXXkgwXHWEjTEU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.971.0/LICENSE
```

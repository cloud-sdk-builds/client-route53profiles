...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HARxcHnnlPAMo2EXytr2O5nsCRFEchVDN8/WtZ5CVEo+7YCfv0XEindd0bWUCC25
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.613.0/index.min.mjs": "sha384-HARxcHnnlPAMo2EXytr2O5nsCRFEchVDN8/WtZ5CVEo+7YCfv0XEindd0bWUCC25"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.613.0/LICENSE
```

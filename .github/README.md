...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UxqEuaE4EYWorS3ljNbVwqJv+zDeEITlCm3UT/GQyq6QY6wB0J0Bbxl4WDOBsglN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.650.0/index.min.mjs": "sha384-UxqEuaE4EYWorS3ljNbVwqJv+zDeEITlCm3UT/GQyq6QY6wB0J0Bbxl4WDOBsglN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.650.0/LICENSE
```

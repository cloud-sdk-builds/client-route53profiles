...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EOkc2pfvzkTow8PkhjShqhFV92ESbmfA3tL5udj9rOSavSFLJ3U27kZwMFU1YX/T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.986.0/index.min.mjs": "sha384-EOkc2pfvzkTow8PkhjShqhFV92ESbmfA3tL5udj9rOSavSFLJ3U27kZwMFU1YX/T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.986.0/LICENSE
```

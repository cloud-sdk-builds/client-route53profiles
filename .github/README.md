...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+wUv8pBcnArqo2INaY+VR05Y/I8eVx4yGeItHJoZCpvKAOtbrYntloS8YDK+jD5E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.857.0/index.min.mjs": "sha384-+wUv8pBcnArqo2INaY+VR05Y/I8eVx4yGeItHJoZCpvKAOtbrYntloS8YDK+jD5E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.857.0/LICENSE
```

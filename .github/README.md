...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MlL0tZLbVrP1TSam8KB4QcNRbWSYDE961RVZkXtlvva1Mmv5QFnEP6NHocjgaVxx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.658.0/index.min.mjs": "sha384-MlL0tZLbVrP1TSam8KB4QcNRbWSYDE961RVZkXtlvva1Mmv5QFnEP6NHocjgaVxx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.658.0/LICENSE
```

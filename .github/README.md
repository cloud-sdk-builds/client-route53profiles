...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M+vwxKGCUy0nWCkn6aunMXZ6qzvHAolcUIcH5Fs1LYVd8C0aGdRTss54AiliMkYV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.587.0/index.min.mjs": "sha384-M+vwxKGCUy0nWCkn6aunMXZ6qzvHAolcUIcH5Fs1LYVd8C0aGdRTss54AiliMkYV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.587.0/LICENSE
```

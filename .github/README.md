...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h8lKYW+AEo57BCQ9PHXSvlqHkT1nkSlqZkWCTH2Hq0JvNfheM98p6puj2GeD/uth
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.922.0/index.min.mjs": "sha384-h8lKYW+AEo57BCQ9PHXSvlqHkT1nkSlqZkWCTH2Hq0JvNfheM98p6puj2GeD/uth"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.922.0/LICENSE
```

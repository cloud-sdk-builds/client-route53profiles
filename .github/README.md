...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1017.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1017.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LG15N8Esc7olh7/QL0v5hH9rBsJDRQhM8hMuwKD/4C0pvptev3IwuiZfzKPb+jup
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1017.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1017.0/index.min.mjs": "sha384-LG15N8Esc7olh7/QL0v5hH9rBsJDRQhM8hMuwKD/4C0pvptev3IwuiZfzKPb+jup"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1017.0/LICENSE
```

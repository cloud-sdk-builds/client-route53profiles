...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pZVi3UTXuneR6TFCc3pd5LexK9GfwsZ4RZEifywOvi6cxfwwKoj8BqOqSI/r1pVl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.665.0/index.min.mjs": "sha384-pZVi3UTXuneR6TFCc3pd5LexK9GfwsZ4RZEifywOvi6cxfwwKoj8BqOqSI/r1pVl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.665.0/LICENSE
```

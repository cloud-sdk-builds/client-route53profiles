...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yAJI3D6jJsfkmaOrqoPoLSHvrH0fnRa7FCEgkUr9E6dCEcC8hkXkaJu5G179e1OT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.962.0/index.min.mjs": "sha384-yAJI3D6jJsfkmaOrqoPoLSHvrH0fnRa7FCEgkUr9E6dCEcC8hkXkaJu5G179e1OT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.962.0/LICENSE
```

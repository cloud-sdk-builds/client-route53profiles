...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.840.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.840.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6R5GsXJftVMFeRQxIjnZFPI6A3Wuj5s6hqo8b+23P4WdQi2iDx2i/HgGo3Hyavpj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.840.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.840.0/index.min.mjs": "sha384-6R5GsXJftVMFeRQxIjnZFPI6A3Wuj5s6hqo8b+23P4WdQi2iDx2i/HgGo3Hyavpj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.840.0/LICENSE
```

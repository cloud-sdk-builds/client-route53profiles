...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZvSWBicK3tM19vTzOwJKotP74ffyRShda1LuVPKtFeNEV3/S4dbUh5NfOx8S24w/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.932.0/index.min.mjs": "sha384-ZvSWBicK3tM19vTzOwJKotP74ffyRShda1LuVPKtFeNEV3/S4dbUh5NfOx8S24w/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.932.0/LICENSE
```

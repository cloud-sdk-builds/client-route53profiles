...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gtFn1FYI8Q/P8V9rAl2cKvUIx2FzMujGpAvfVbDOmuxHr/FpPCSaRdb2kc7+yd1k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.990.0/index.min.mjs": "sha384-gtFn1FYI8Q/P8V9rAl2cKvUIx2FzMujGpAvfVbDOmuxHr/FpPCSaRdb2kc7+yd1k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.990.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2w6PnRUBr4urG1fF77QLTGv2aPF8tPNTkLC8e8ZWsi00DklP3dmxa4DHH2yL4fGV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.908.0/index.min.mjs": "sha384-2w6PnRUBr4urG1fF77QLTGv2aPF8tPNTkLC8e8ZWsi00DklP3dmxa4DHH2yL4fGV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.908.0/LICENSE
```

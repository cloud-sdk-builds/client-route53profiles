...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qG2xvQOtJk/j0wgR3kmtrHS8Uz20pp4tkCnbEexo8TPEOtjarAQgSc4P7f/QQSt8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.970.0/index.min.mjs": "sha384-qG2xvQOtJk/j0wgR3kmtrHS8Uz20pp4tkCnbEexo8TPEOtjarAQgSc4P7f/QQSt8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.970.0/LICENSE
```

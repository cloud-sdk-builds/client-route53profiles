...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-txDtE7XVtTloVmLK1p1xG+Y4IILn2+ptrtBI8YbVa+kAoOW00F9c8gGuB5Xat+eu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.911.0/index.min.mjs": "sha384-txDtE7XVtTloVmLK1p1xG+Y4IILn2+ptrtBI8YbVa+kAoOW00F9c8gGuB5Xat+eu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.911.0/LICENSE
```

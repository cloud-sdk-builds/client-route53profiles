...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4Y7ux0IOhFjWeTAvPB2+65ePJgnw2Rl9EWdwLQPesvbc+nV58P6t5gMMo+2DULPp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.913.0/index.min.mjs": "sha384-4Y7ux0IOhFjWeTAvPB2+65ePJgnw2Rl9EWdwLQPesvbc+nV58P6t5gMMo+2DULPp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.913.0/LICENSE
```

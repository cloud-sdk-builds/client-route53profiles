...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-CHxpjEsLpK/PVexFzXdZnqRWmSIlFjWiUM2AFEyjlThQec4s8jeGn+yFLKnuIjkL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.726.1/index.min.mjs": "sha384-CHxpjEsLpK/PVexFzXdZnqRWmSIlFjWiUM2AFEyjlThQec4s8jeGn+yFLKnuIjkL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.726.1/LICENSE
```

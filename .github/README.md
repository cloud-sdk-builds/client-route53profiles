...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a3THUFvNzlGBxNvzAaLdFxpWQsZVKJnMasLe5KPH5tmI4qckgi6NJy10Wqj9UpII
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.649.0/index.min.mjs": "sha384-a3THUFvNzlGBxNvzAaLdFxpWQsZVKJnMasLe5KPH5tmI4qckgi6NJy10Wqj9UpII"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.649.0/LICENSE
```

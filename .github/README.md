...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YZitMk+Ijl4vKG4lIfYUpzd07KCbXgMRV2cYJpQcigdAZBlDdzGq5Hi8+u/XYt1x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.723.0/index.min.mjs": "sha384-YZitMk+Ijl4vKG4lIfYUpzd07KCbXgMRV2cYJpQcigdAZBlDdzGq5Hi8+u/XYt1x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.723.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pTBe/pqDIg+a1vnl5cO5k0apN+amPqaEhq2St7bca6hamtx9ZVzdvbT6HGzOfeAz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.686.0/index.min.mjs": "sha384-pTBe/pqDIg+a1vnl5cO5k0apN+amPqaEhq2St7bca6hamtx9ZVzdvbT6HGzOfeAz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.686.0/LICENSE
```

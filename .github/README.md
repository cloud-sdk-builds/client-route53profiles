...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LWy4yLHEWF5Gr1G7HK88hkyec5LxGQvPSztRNWR8Hv8NxTTmjhiTsKxJfHwP2+1v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.906.0/index.min.mjs": "sha384-LWy4yLHEWF5Gr1G7HK88hkyec5LxGQvPSztRNWR8Hv8NxTTmjhiTsKxJfHwP2+1v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.906.0/LICENSE
```

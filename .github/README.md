...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3Yups3J8+4Sf+SJ0WKiOfOB6xkMAD17s9NHIJJy63EwI6v/TJvRn17mZTpYGeGKF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.654.0/index.min.mjs": "sha384-3Yups3J8+4Sf+SJ0WKiOfOB6xkMAD17s9NHIJJy63EwI6v/TJvRn17mZTpYGeGKF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.654.0/LICENSE
```

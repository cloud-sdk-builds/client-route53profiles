...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1011.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1011.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MgX8t8QjVkM/DUdis+Pybv87cv9wAKYkfqLorFYc9mroPvywS11ke3FL7LpEGhfG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1011.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1011.0/index.min.mjs": "sha384-MgX8t8QjVkM/DUdis+Pybv87cv9wAKYkfqLorFYc9mroPvywS11ke3FL7LpEGhfG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1011.0/LICENSE
```

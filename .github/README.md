...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6pg6Tl/jA6fW4GVVsnGuusrElj6nMeO+kCTwSZz4xoLZzvVQU4I+PGSTIx5DW/Vz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.933.0/index.min.mjs": "sha384-6pg6Tl/jA6fW4GVVsnGuusrElj6nMeO+kCTwSZz4xoLZzvVQU4I+PGSTIx5DW/Vz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.933.0/LICENSE
```

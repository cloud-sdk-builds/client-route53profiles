...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z+kK0BckhhnBGlrMB+wArd8Ugk2oIu+axFSN4Vah6yWNTHve0fMh8qreWQ2v5PWu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.1014.0/index.min.mjs": "sha384-z+kK0BckhhnBGlrMB+wArd8Ugk2oIu+axFSN4Vah6yWNTHve0fMh8qreWQ2v5PWu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.1014.0/LICENSE
```

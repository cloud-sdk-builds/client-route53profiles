...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mqKS7FAdDgN/lUWcN0lo34Vq/pyk1noLIWLz3Gc9bKx9qaXYvowrBj8PUM7NmbZW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.886.0/index.min.mjs": "sha384-mqKS7FAdDgN/lUWcN0lo34Vq/pyk1noLIWLz3Gc9bKx9qaXYvowrBj8PUM7NmbZW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.886.0/LICENSE
```

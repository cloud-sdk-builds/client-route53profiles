...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-79ACl1rCmNqDfUnKhQcBrD170RVwqkarO7f4lM/ZsUgRJSU2eW81YloDQJWTIE58
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.583.0/index.min.mjs": "sha384-79ACl1rCmNqDfUnKhQcBrD170RVwqkarO7f4lM/ZsUgRJSU2eW81YloDQJWTIE58"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.583.0/LICENSE
```

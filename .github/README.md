...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZLONeUlvdh2ZIoGWobLHEhb2c7s9Vb4dn8zTNvwZYVyNYC6yP+QzvEBEk0ll621C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.930.0/index.min.mjs": "sha384-ZLONeUlvdh2ZIoGWobLHEhb2c7s9Vb4dn8zTNvwZYVyNYC6yP+QzvEBEk0ll621C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.930.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cfm4JquGdGUzhxM0W+ADtKMzKb8+1Rz8FJkTWQRktx1LZhL9e4h5KTk2ezwhxVea
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.614.0/index.min.mjs": "sha384-Cfm4JquGdGUzhxM0W+ADtKMzKb8+1Rz8FJkTWQRktx1LZhL9e4h5KTk2ezwhxVea"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.614.0/LICENSE
```

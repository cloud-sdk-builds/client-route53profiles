...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pVe3sFCtyuoxe0USQIwMh9O08e0oNYZ5TZWoBDT0mHiEvYDy4G08EmlEaXw3jh8Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.726.0/index.min.mjs": "sha384-pVe3sFCtyuoxe0USQIwMh9O08e0oNYZ5TZWoBDT0mHiEvYDy4G08EmlEaXw3jh8Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.726.0/LICENSE
```

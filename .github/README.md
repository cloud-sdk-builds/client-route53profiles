...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.560.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.560.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9zOjUtnK28QWNcrb9qwHH9T4I58eSbcciyTOkL326g2sco2vfYrrBIPGp0lZaoyJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.560.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.560.0/index.min.mjs": "sha384-9zOjUtnK28QWNcrb9qwHH9T4I58eSbcciyTOkL326g2sco2vfYrrBIPGp0lZaoyJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.560.0/LICENSE
```

...
[`@aws-sdk/client-route53profiles`](https://www.npmjs.com/package/@aws-sdk/client-route53profiles/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hm3tZXamHj1g7cpGUfHhcYG8t82LDC5g/5FiV/pWofFMOdSLqhfldxV6wuT+JmEx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53profiles@3.696.0/index.min.mjs": "sha384-hm3tZXamHj1g7cpGUfHhcYG8t82LDC5g/5FiV/pWofFMOdSLqhfldxV6wuT+JmEx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route53profiles/blob/refs/tags/3.696.0/LICENSE
```
